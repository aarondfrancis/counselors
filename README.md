...
`counselors` dispatches the same prompt to Claude, Codex, Gemini, Amp, Cursor, or custom tools simultaneously, collects their responses, and writes everything to a structured output directory.
...
| Cursor Agent | `cursor-agent` | enforced | [cursor.com/cli](https://cursor.com/cli) |
